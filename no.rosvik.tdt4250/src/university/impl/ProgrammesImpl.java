...
public class ProgrammesImpl extends MinimalEObjectImpl.Container implements Programmes {
	 ...
	 * @ordered
	 */
	protected EList<ProgrammeInstances> instances;
	...
	protected EClass eStaticClass() {
		return UniversityPackage.Literals.PROGRAMMES;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityPackage.PROGRAMMES__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UniversityPackage.PROGRAMMES__INSTANCES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UniversityPackage.PROGRAMMES__INSTANCES:
				getInstances().clear();
				getInstances().addAll((Collection<? extends ProgrammeInstances>)newValue);
				return;
			case UniversityPackage.PROGRAMMES__NAME:
